...
export const getProducts = asyncHandler(async (req, res) => {
  const {
    ...
    const formattedProducts = products.map((product) => ({
      ...
      price: product.price,
      imageUrl: product.images && product.images.length > 0 ? product.images[0] : "https://placehold.co/400x300",
...
export const getProductById = asyncHandler(async (req, res) => {
    ...
    const formattedProduct = {
      ...
      price: product.price,
      images: product.images.length > 0 ? product.images : ["https://placehold.co/400x300"],
      condition: product.condition,
      conditionColor: getConditionColor(product.condition),
      sellerName: product.sellerName || product.seller?.name || "Unknown",
...
export const getProductMetadata = asyncHandler(async (req, res) => {
    ...
    // Lấy distinct locations từ products
